class PausePosition{
    ...
    draw(play){
        ...
        ctx.fillText("UFO Pause", play.width / 2, play.height / 2 - 300);

        ctx.font = "40px Comic Sans MS";
        ctx.fillStyle = "#D7DF01";
        ctx.fillText("Press 'P' to back in game.", play.width / 2, play.height / 2 - 250);
        ctx.fillText("Press 'ESC' to quit current game.", play.width / 2, play.height / 2 - 210);
